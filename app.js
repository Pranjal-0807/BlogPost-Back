...
// }
// {
// npm i dotenv => to read custom environment variables from .env file by which we'll save
...
// console.log(USER_NAME, PASSWORD, DB_NAME);
// }
// }
const DB_URI = `mongodb+srv://${USER_NAME}:${PASSWORD}@merncluster.zan8h.mongodb.net/${DB_NAME}?retryWrites=true&w=majority&appName=mernCluster`;
const PORT = 3000;
